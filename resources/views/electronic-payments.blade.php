...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Electronic Payments - Turf Crew Alabama</title>
    ...
    <body>
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="/electronic-payments">Electronic Payments</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="bg-success text-white py-4">
            <div class="container">
                <h1 class="display-4 fw-bold mb-0">Electronic Payments</h1>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">
                            Our electronic payment system accepts all major credit cards and ACH bank transfers, giving you the flexibility to choose the payment method that works best for your budget and preferences. Set up automatic payments and never worry about missed due dates again.
                        </p>
                        
                        <p class="mb-4">
                            Security is our top priority. All payment information is processed through encrypted, PCI-compliant systems that protect your financial data. Your payment details are never stored on our local systems, ensuring maximum protection against data breaches and unauthorized access.
                        </p>
                        
                        <p class="mb-4">
                            Electronic payments streamline our entire process, allowing us to focus more time and resources on what matters most – caring for your lawn. You'll receive email confirmations for all transactions, and our online portal lets you view payment history, update payment methods, and manage your account 24/7.
                        </p>
                        
                        <p class="mb-0">
                            Experience the convenience of modern payment solutions with Turf Crew Alabama. No more waiting for checks to clear, no more cash handling, and no more missed payments. Just simple, secure, and automatic transactions that keep your lawn care service running smoothly.
                        </p>
                    </div>
                </div>
            </div>
